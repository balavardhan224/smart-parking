...
import 'package:smart_parking/models/locations.dart';
import 'package:smart_parking/screens/mainPage.dart';
import 'package:smart_parking/services/locations.dart';
import 'package:smart_parking/widgets/locations_card.dart';
...
class _ParkVehicleHomeState extends State<ParkVehicleHome> {
  ...
  Future<void> getLocations() async {
    setState(() async {
      final List<DocumentSnapshot> documents = await GeoFirestore(
              FirebaseFirestore.instance.collection('parkingPlaces'))
